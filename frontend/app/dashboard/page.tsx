    ...
    <AppShell
      ...
      action={
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link
            href="/chat"
            className="flex items-center gap-2 rounded-lg border border-purple-500/30 bg-purple-600/10 px-4 py-2 text-sm font-semibold text-purple-300 hover:bg-purple-600 hover:text-white transition-all"
          >
        ...
        <div className="relative overflow-hidden rounded-2xl border border-indigo-500/20 bg-gradient-to-r from-indigo-950/60 via-purple-950/40 to-zinc-950 p-6 md:p-8">
          <div className="relative z-10 max-w-2xl space-y-2">
            <div className="inline-flex items-center gap-2 rounded-full bg-indigo-500/10 px-3 py-1 text-xs font-semibold text-indigo-400 border border-indigo-500/20">
              ...
              <span>Phase 4 Hardening Active</span>
            </div>
            <h2 className="text-xl font-bold text-white md:text-2xl">
              Welcome to NexusAI Knowledge Workspace
            </h2>
            <p className="text-sm text-zinc-400">
              Upload your documents, generate vector index embeddings with Gemini,
              and query grounded answers with explicit page and score citations.
            </p>
          </div>
